...
- 运行时版本：默认部署要求 Python 3.10+、Node.js 18+，因为 DreamingRAG 要求 Python 3.10+。
- 依赖安装：后端 `pip install -r requirements.txt && pip install -e ../DreamingRAG`；前端 `cd frontend && npm ci`。
