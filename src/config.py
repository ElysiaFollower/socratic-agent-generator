...
# lab manuals
LAB_MANUALS_DIR_NAME = 'lab_manuals'
LAB_MANUALS_DIR = DATA_DIR / LAB_MANUALS_DIR_NAME

# generated curricula
CURRICULA_DIR_NAME = 'curricula'
CURRICULA_DIR = DATA_DIR / CURRICULA_DIR_NAME

# generated personas
PERSONAS_DIR_NAME = 'personas'
PERSONAS_DIR = DATA_DIR / PERSONAS_DIR_NAME
